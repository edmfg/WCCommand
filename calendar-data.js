        ...
        entries: [
          {
            ...
            prompt:
              "why do Canadian fans take shots of maple syrup before a game",
          },
          {
            start: "2026-06-28",
            end: "2026-07-03",
            phase: "r32",
            type: "cultural-through",
            tbd: true,
        ...
        entries: [
          {
            ...
            prompt:
              "what are some traditional watch party foods i can make with a bosnian flair",
          ...
          },
          {
            ...
            prompt:
              "what are some easy ivorian street foods i can make for a watch party",
          },
          {
            start: "2026-06-28",
            end: "2026-07-03",
      ...
      },
      {
        ...
        entries: [
          ...
          },
          {
            ...
            prompt:
              "why do egypt fans bring giant golden trumpets to soccer matches",
          },
          {
            start: "2026-06-28",
            end: "2026-07-03",
        ...
        entries: [
          {
            ...
            prompt:
              "what do the specific patterns on the robes worn by ghanaian soccer fans mean",
          },
          {
            start: "2026-06-28",
            end: "2026-07-03",
        ...
        entries: [
          {
            ...
            prompt:
              "i heard qatar has falcons at soccer matches, whats the history of this",
        ...
        entries: [
          {
            ...
            prompt:
              "why do swiss soccer fans always think stadiums could use more cowbell",
      ...
      },
      {
        ...
        entries: [
          ...
          },
          {
            ...
            prompt:
              "since the goalie can pick up the ball, why don't they always pick it up",
          },
          {
            start: "2026-07-08",
            end: "2026-07-14",
            ...
            prompt:
              "is there any science to support that superstitions actually help soccer teams win",
          },
        ],
      },
      {
        ...
        entries: [
          ...
          },
          {
            ...
            prompt:
              "help me learn how to kick a ball like a pro, so it curves and dips in mid-air",
          },
          {
            start: "2026-07-08",
            end: "2026-07-14",
            ...
            prompt:
              "how do strikers jump so high to win headers, can i learn how",
          },
        ],
      },
      {
        ...
        entries: [
          {
            ...
            prompt:
              "whats the symbolism of the fast leg-kicking dance that senegalese fans do",
          },
        ],
      },
      {
        ...
        entries: [
          {
            ...
            prompt:
              "how do soccer players train to play in climates different than their home countries",
          },
        ],
      },
      {
