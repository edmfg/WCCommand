...
_Last updated 2026-06-04. Not deployed (listed in `.vercelignore`)._
...
### Decisions
- [ ] Masthead back link still reads **"World Cup HQ"** and links to the
      dashboard — change the label / destination for this campaign?
- [ ] genius.html is **public** (anyone with the link) — gate it before sharing
      externally?
- [ ] Partner **"Genius Sports"** headline now matches the hero size (44px) and
...
## How-tos (reminders)
- Edit copy live at `…/engine.html?edit=1` or `…/genius.html?edit=1`; the
  toolbar has B/I/U, color, font size, Capitalization, Clear, then **Copy edits**
  → paste back to Claude to bake into source.
- **Reset** on the toolbar clears your browser's edit cache and reloads the clean
  source.
- Export a board as a JPEG with the **Export JPEG** pill (bottom-right).
