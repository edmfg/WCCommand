(function () {
  ...
  function setupDrag(pill) {
    var dragging = false, startX = 0, startY = 0, originX = 0, originY = 0, moved = false;
  ...
  function tick(pill) {
    ...
    function update() {
      ...
      if (f.kickedOff) {
        pill.innerHTML = '<span class="wcc-emoji" aria-hidden="true">⚽</span><span class="wcc-num">' + f.text + '</span>';
        return;
      }
